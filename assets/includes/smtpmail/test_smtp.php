 ...
 */
  ...
  /* Uncomment when using SASL authentication mechanisms */
	...
	*/
	...
	$from="mmrda.tracker@bdbindia.org";                           /* Change this to your address like "me@mydomain.com"; */ $sender_line=__LINE__;
	...
	$smtp->host_name="mailmx.bdbindia.org";       /* Change this variable to the address of the SMTP server to relay, like "smtp.myisp.com" */
	...
	$smtp->localhost="mailmx.bdbindia.org";       /* Your computer address */
	...
	$smtp->user="mmrdat";                     /* Set to the user name if the server requires authetication */
	$smtp->realm="";                    /* Set to the authetication realm, usually the authentication user e-mail domain */
	$smtp->password="demo@123";                 /* Set to the authetication password */
	...
	if($smtp->SendMessage(
		...
		array(
			$to,
				/* 'anil@centerac.com',
				'satish@centerac.com',
				'babitha@centerac.com', */
		),
		array(
			"From: $from",
			"To: $to",
			"Cc: divyesh@centerac.com",
			"Bcc: divyesh@centerac.com",
			"MIME-Version: 1.0",
			"Content-type: text/html; charset=iso-8859-1",
			"Subject: Testing GMX' SMTP class",
