 ...
 */
  ...
  /* Uncomment when using SASL authentication mechanisms */
	...
	*/
	...
	$from="daregang@gmx.com";                           /* Change this to your address like "me@mydomain.com"; */ $sender_line=__LINE__;
	...
	$smtp->user="daregang@gmx.com";                     /* Set to the user name if the server requires authetication */
	$smtp->realm="";                    /* Set to the authetication realm, usually the authentication user e-mail domain */
	$smtp->password="blackmushk123";                 /* Set to the authetication password */
